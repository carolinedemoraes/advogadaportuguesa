  ...
  return (
    <>
      <div className="content">
        <TextImg imgSrc={"/public/images/advogadapt.jpg"}>
          <Menu />
          <Title />
        </TextImg>
        <TextImg imgSrc={"/public/images/passaporte.jpg"} leftImg>
        ...
        <TextImg imgSrc={"/public/images/direito.jpg"}>
        ...
        <TextImg imgSrc={"/public/images/bandeirapt.jpg"} leftImg>
          ...
          <p className="text3">
            ...
            europeu incluem:
            <li>
              <strong> 1. Mobilidade:</strong> Como cidadão europeu, você tem o
              direito de circular, residir,estudar e trabalhar livremente em
              qualquer país da União Europeia (UE) e do Espaço Econômico Europeu
              (EEE).
            </li>
            <li>
              <strong>2. Emprego:</strong> Como cidadão europeu, você tem acesso
              a todas as oportunidades de emprego e treinamento oferecidas em
              qualquer país da UE ou do EEE, assim você pode aproveitar as
              melhores oportunidades de emprego em qualquer país europeu sem
              precisar de autorização de trabalho.
            </li>
            <li>
            ...
            <li>
              <strong>4. Qualidade de vida:</strong> Como cidadão europeu, você
              tem acesso a alguns dos melhores serviços públicos do mundo,
              incluindo saúde, assistência social e transporte público. Além
              disso, você também tem direito à proteção consular e assistência
              legal em qualquer país da UE ou do EEE.
            </li>
            <li>
            ...
            <li>
              <strong>6. Direitos Políticos:</strong> Como cidadão europeu, você
              tem o direito de votar e se candidatar às eleições para o
            ...
            <p className="text3">
              Como cidadão da UE, você pode desfrutar de uma série de benefícios
              e oportunidades que não estão disponíveis para cidadãos de outros
              países. Portanto, se você tiver a oportunidade de se tornar um
              cidadão europeu, através da sua cidadania portuguesa, certamente
              será uma escolha vantajosa para sua vida pessoal e profissional.
            </p>
          </p>
        </TextImg>
        <TextImg imgSrc={"/public/images/portugal1.jpg"}>
          ...
          <p className="text4">
            ...
            <a
              href="mailto:andreia-66927p@adv.oa.pt"
              className="social-network"
            >
              <FaEnvelope />
            </a>
